This application has a whitelist mechanism that obtains the data from mysql database and return it to to the transactionms using Kafka messaging service. 
